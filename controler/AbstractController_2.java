...
import Backing.*;
import Session.AbstractFacade_3;
import Session.AbstractFacade_2;
 ...
 * Segunda modificacion de martin
 * Tercera modificacion de martin
 */
...
public abstract class AbstractController_2<T> implements Serializable {
    ...
    @Inject
    private AbstractFacade_3<T> ejbFacade;
    ...
    public AbstractController_2() {
    }

    public AbstractController_2(Class<T> itemClass) {
...
//        }
    ...
    public Collection<T> Consulta(String consulta1, String credencial1){
       items = ejbFacade.Consulta(consulta1, credencial1);
       return items;
    }
...
//    }
    ...
    public void save(ActionEvent event) {
        String nombre = itemClass.getSimpleName();
        String msg = ResourceBundle.getBundle("com.sfp.property/MyBundle").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("com.sfp.property/MyBundle").getString(itemClass.getSimpleName() + "Created");
        ...
        if (selected != null) {
            ...
            try {
                if (persistAction != PersistAction.DELETE) {
                    //EntityManager kk = this.ejbFacade.getEntityManager();
