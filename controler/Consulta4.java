 ...
 * @author jleal
 */
@Named(value = "consulta1Controler4")
//@SessionScoped 
@ViewScoped
    ...
    public void  ObtenSolicitudes(int flag){    
       ...
       if((FechaInicial == null) || (FechaFin == null)){
           ...
           String consulta1 = "SELECT c FROM CauSolicitudtrabajos c " 
                        + " WHERE c.idSolicitud.idMesaserv.idMesaserv in (" + Mesaservicio + ") and "
                        + "  c.idEstatus.idEstatus = 4   and c.fechaasigdepto between  ?1  and  ?2 order by c.idSoltrab ";
